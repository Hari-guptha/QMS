...
const translations: Translations = {
  ...
  'common.exporting': { en: 'Exporting...', ar: 'جاري التصدير...' },
  ...
  'customer.redirectingIn': { en: 'Redirecting in', ar: 'إعادة التوجيه خلال' },
  'customer.seconds': { en: 'seconds', ar: 'ثواني' },
  ...
  'admin.visitors.export': { en: 'Export', ar: 'تصدير' },
  'admin.visitors.export.title': { en: 'Export Visitors', ar: 'تصدير الزوار' },
  'admin.visitors.export.filters': { en: 'Filters', ar: 'المرشحات' },
  'admin.visitors.export.options': { en: 'Export Options', ar: 'خيارات التصدير' },
  'admin.visitors.export.type': { en: 'Export Type', ar: 'نوع التصدير' },
  'admin.visitors.export.fullInfo': { en: 'Full Information', ar: 'معلومات كاملة' },
  'admin.visitors.export.fullInfoDesc': { en: 'Includes ticket details and visitor history', ar: 'يتضمن تفاصيل التذاكر وسجل الزوار' },
  'admin.visitors.export.visitorOnly': { en: 'Visitor Info Only', ar: 'معلومات الزوار فقط' },
  'admin.visitors.export.visitorOnlyDesc': { en: 'Unique visitors with summary statistics', ar: 'زوار فريدون مع إحصائيات ملخصة' },
  'admin.visitors.export.format': { en: 'Export Format', ar: 'تنسيق التصدير' },
  'admin.visitors.export.recordsFound': { en: 'records will be exported', ar: 'سجل سيتم تصديره' },
  'admin.visitors.export.export': { en: 'Export Data', ar: 'تصدير البيانات' },
  'admin.visitors.export.noData': { en: 'No data to export. Please adjust your filters.', ar: 'لا توجد بيانات للتصدير. يرجى تعديل المرشحات.' },
  'admin.visitors.export.error': { en: 'Failed to export data. Please try again.', ar: 'فشل تصدير البيانات. يرجى المحاولة مرة أخرى.' },
  'admin.visitors.export.searchService': { en: 'Search services...', ar: 'بحث عن الخدمات...' },
  'admin.visitors.export.searchAgent': { en: 'Search agents...', ar: 'بحث عن الموظفين...' },
  'admin.visitors.export.noServicesFound': { en: 'No services found', ar: 'لم يتم العثور على خدمات' },
  'admin.visitors.export.noAgentsFound': { en: 'No agents found', ar: 'لم يتم العثور على موظفين' },
  'admin.visitors.export.selectStatusesDesc': { en: 'Select specific ticket statuses to include in the export. Leave empty to include all statuses.', ar: 'حدد حالات التذاكر المحددة لتضمينها في التصدير. اتركه فارغًا لتضمين جميع الحالات.' },
  'admin.visitors.export.selectServicesDesc': { en: 'Select services to include in the export. Leave empty to include all services.', ar: 'حدد الخدمات لتضمينها في التصدير. اتركه فارغًا لتضمين جميع الخدمات.' },
  'admin.visitors.export.selectAgentsDesc': { en: 'Select agents to include in the export. Leave empty to include all agents.', ar: 'حدد الموظفين لتضمينهم في التصدير. اتركه فارغًا لتضمين جميع الموظفين.' },
  'admin.visitors.export.filterByVisitors': { en: 'Filter by Visitors (Optional)', ar: 'تصفية حسب الزوار (اختياري)' },
  'admin.visitors.export.selectVisitorsDesc': { en: 'Select visitors to include in the export. Leave empty to include all visitors.', ar: 'حدد الزوار لتضمينهم في التصدير. اتركه فارغًا لتضمين جميع الزوار.' },
  ...
  'admin.analytics.dateRange': { en: 'Date Range', ar: 'النطاق الزمني' },
  'admin.analytics.category': { en: 'Category', ar: 'الفئة' },
  'admin.analytics.pending': { en: 'Pending', ar: 'قيد الانتظار' },
  'admin.analytics.serving': { en: 'Serving', ar: 'قيد الخدمة' },
  'admin.analytics.hold': { en: 'Hold', ar: 'معلق' },
  'admin.analytics.avgWait': { en: 'Avg Wait', ar: 'متوسط الانتظار' },
  'admin.analytics.avgCalledToServing': { en: 'Avg Called→Serving', ar: 'متوسط الاستدعاء←الخدمة' },
  'admin.analytics.avgTotal': { en: 'Avg Total', ar: 'المتوسط الإجمالي' },
  'admin.analytics.avgService': { en: 'Avg Service', ar: 'متوسط الخدمة' },
  'admin.analytics.servicesLabel': { en: 'Services', ar: 'الخدمات' },
  'admin.analytics.agentsLabel': { en: 'Agents', ar: 'الموظفون' },
  ...
  'admin.analytics.filterByStatus': { en: 'Filter by Status (Optional)', ar: 'تصفية حسب الحالة (اختياري)' },
  'admin.analytics.selectStatusesDesc': { en: 'Select specific ticket statuses to include in the report. Leave empty to include all statuses.', ar: 'اختر حالات التذاكر المحددة لتضمينها في التقرير. اتركه فارغًا لتضمين جميع الحالات.' },
  'admin.analytics.statuses': { en: 'statuses', ar: 'حالات' },
  'admin.analytics.statusFilter': { en: 'Status Filter', ar: 'فلتر الحالة' },
  'admin.analytics.cancelled': { en: 'Cancelled', ar: 'ملغي' },
  'admin.analytics.noShow': { en: 'No Show', ar: 'لم يحضر' },
  ...
  'admin.analytics.widget.dayOfWeekDistribution': { en: 'Day of Week Distribution', ar: 'توزيع أيام الأسبوع' },
  ...
  'agent.calendar.holdAt': { en: 'Hold At', ar: 'تاريخ التعليق' },
  ...
  'common.holdAt': { en: 'Hold At', ar: 'تاريخ التعليق' },
