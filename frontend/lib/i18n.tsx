...
const translations: Translations = {
  ...
  'admin.analytics.export': { en: 'Export Excel', ar: 'تصدير Excel' },
  'admin.analytics.agentPerformance': { en: 'Agent Performance', ar: 'أداء الموظف' },
  'admin.analytics.searchAgents': { en: 'Search agents by name or email...', ar: 'بحث عن الموظفين بالاسم أو البريد الإلكتروني...' },
